...
➪ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ʜᴇʟᴘ ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴍᴏʀᴇ ᴍʏ ғᴇᴀᴛᴜʀᴇs.
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}","*Nobisuki Is Alive ⚡*", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
